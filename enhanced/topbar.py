...
def get_welcome_image():
    ...
    if not os.path.isfile(skip.jpg):                   # if skip.jpg exists then ignore all jpgs & jpegs
    ...
    if not os.path.isfile(skip.png):                   # if skip.png exists then use the fallback, welcome.png    
