...
def create_user_structure():
  ...
  shutil.copytree('.masters/master_batch_startups', f'{args_manager.args.user_dir}/batch_startups', dirs_exist_ok = True)
  shutil.copytree('.masters/master_control_images', f'{args_manager.args.user_dir}/control_images', dirs_exist_ok = True)
  shutil.copytree('.masters/master_welcome_images', f'{args_manager.args.user_dir}/welcome_images', dirs_exist_ok = True)
  shutil.copytree('.masters/master_wildcards', f'{args_manager.args.user_dir}/wildcards', dirs_exist_ok = True)
  ...
  shutil.copytree('.masters/master_topics', f'{args_manager.args.user_dir}/master_topics', dirs_exist_ok = True)
