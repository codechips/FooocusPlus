...
def create_user_structure():  
  ...
  shutil.copytree('./master_batch_startups', os.path.abspath(os.path.join(args_manager.args.user_dir, '/batch_startups')), dirs_exist_ok = True)
  shutil.copytree('./master_control_images', os.path.abspath(os.path.join(args_manager.args.user_dir, '/control_images')), dirs_exist_ok = True)
  shutil.copytree('./master_presets', os.path.abspath(os.path.join(args_manager.args.user_dir, '/presets')), dirs_exist_ok = True)
  shutil.copytree('./master_welcome_images', os.path.abspath(os.path.join(args_manager.args.user_dir, '/welcome_images')), dirs_exist_ok = True)
  shutil.copytree('./master_wildcards', os.path.abspath(os.path.join(args_manager.args.user_dir, '/wildcards')), dirs_exist_ok = True)
  return
os.path.abspath(os.path.join(args_manager.args.user_dir, '/batch_startups'))
