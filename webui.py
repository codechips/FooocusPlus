    ...
    with gr.Row():
        with gr.Column(scale=2):
            ...
            with gr.Row(elem_classes='advanced_check_row'):
                ...
                auto_describe_checkbox = gr.Checkbox(label='Auto-Describe', visible=gr.update(modules.config.default_image_prompt_checkbox), value=args_manager.args.enable_auto_describe_image, container=False, elem_classes='min_check') 
