...
#                        ValueError: orginal coding "ValueError" is not recognized
            ...
            auto_describe_checkbox.change(lambda x: modules.config.enable_auto_describe_image = not modules.config.enable_auto_describe_image, inputs=auto_describe_checkbox)
